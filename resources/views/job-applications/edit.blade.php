            ...
            <div class="bg-white shadow-sm sm:rounded-lg overflow-hidden border border-gray-200">
                ...
                <div class="{{ $bannerColor }} px-6 py-3 flex items-center justify-between">
                    <div class="flex items-center">
                        <span
                            class="inline-flex items-center justify-center h-8 w-8 rounded-full bg-white bg-opacity-25 mr-3">
                    ...
                    <div class="text-sm text-white opacity-80">
                        <span>Applied
                            {{ $jobApplication->application_date ? $jobApplication->application_date->diffForHumans() : 'N/A' }}</span>
                    </div>
                </div>
                ...
                <div class="p-6 sm:p-8">
                    <form method="POST" action="{{ route('job-applications.update', $jobApplication) }}"
                        class="space-y-6" id="update-form">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="flex flex-row gap-6 w-full justify-between">
                            ...
                            <div class="border-b border-gray-200 pb-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
                                    <div class="col-span-1">
                                        ...
                                        <div class="relative rounded-md shadow-sm">
                                            ...
                                            <input type="text" name="job_title" id="job_title"
                                                class="pl-10 py-4 block w-full rounded-full border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                                                value="{{ $jobApplication->job_title }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-span-1">
                                        ...
                                        <div class="relative rounded-md shadow-sm">
                                            ...
                                            <input type="text" name="company_name" id="company_name"
                                                class="pl-10 py-4 block w-full rounded-full border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                                                value="{{ $jobApplication->company_name }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-span-1">
                                        <label for="job_type" class="block text-sm font-medium text-gray-700 mb-1">Job
                                            Type</label>
                                        <div class="relative rounded-md shadow-sm">
                                            <select name="job_type" id="job_type"
                                                class="block py-4 w-full rounded-full border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
                                    <div class="col-span-1">
                                        ...
                                        <div class="relative rounded-md shadow-sm">
                                            <select name="status" id="status"
                                                ...
                                                <option value="Interview" {{ ($jobApplication->status == 'Interview' || $jobApplication->status == 'Interviewing') ? 'selected' : '' }}>
                                                    Interview
                                                </option>
                                    ...
                                    <div class="col-span-1">
                                        <label for="application_date"
                                            class="block text-sm font-medium text-gray-700 mb-1">Application Date <span
                                                class="text-red-500">*</span></label>
                                        <div class="relative rounded-md shadow-sm">
                                            <div
                                                class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                            ...
                                            <input type="date" name="application_date" id="application_date"
                                                class="pl-10 py-4 block w-full rounded-full border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                                                value="{{ $jobApplication->application_date ? $jobApplication->application_date->format('Y-m-d') : '' }}"
                                                required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-span-1">
                                        <label for="salary"
                                            class="block text-sm font-medium text-gray-700 mb-1">Salary/Compensation</label>
                                        <div class="relative rounded-md shadow-sm">
                                            <div
                                                class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                            ...
                                            <input type="text" name="salary" id="salary"
                                                class="pl-7 py-4 block w-full rounded-full border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                                                value="{{ $jobApplication->salary ?? '' }}" placeholder="75,000">
                                        </div>
                                    </div>

                                    <div class="col-span-1">
                                        <label for="reminder_date"
                                            class="block text-sm font-medium text-gray-700 mb-1">Reminder Date</label>
                                        <div class="relative rounded-md shadow-sm">
                                            <div
                                                class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400"
                                            ...
                                            <input type="date" name="reminder_date" id="reminder_date"
                                                class="pl-10 py-4 block w-full rounded-full border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                                                value="{{ $jobApplication->reminder_date ? $jobApplication->reminder_date->format('Y-m-d') : '' }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 gap-y-5">
                                <div>
                                    <label for="job_link" class="block text-sm font-medium text-gray-700 mb-1">Job
                                        Posting URL</label>
                                    <div class="relative rounded-md shadow-sm">
                                        <div
                                            class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                        ...
                                        <input type="url" name="job_link" id="job_link"
                                            class="pl-10 py-4 block w-full rounded-full border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                                ...
                                <div>
                                    ...
                                    <div class="mt-1">
                                        <textarea name="notes" id="notes" rows="4"
                                            class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">{{ $jobApplication->notes }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="flex items-center justify-between pt-4">
                        <div> <!-- Wrap delete button in a div for layout -->
                            <form method="POST" action="{{ route('job-applications.destroy', $jobApplication) }}"
                                class="inline" id="delete-form">
                                @csrf
                                @method('DELETE')
                                <button type="button"
                                    onclick="if(confirm('Are you sure you want to delete this job application?')) document.getElementById('delete-form').submit();"
