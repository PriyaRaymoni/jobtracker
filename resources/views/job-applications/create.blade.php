                ...
                <div class="p-6 sm:p-8">
                    <form method="POST" action="{{ route('job-applications.store') }}">
                        ...
                        <div>
                                        ...
                                        <div class="col-span-1">
                                            ...
                                            <div class="relative rounded-md shadow-sm">
                                                ...
                                                <input type="text" name="job_title" id="job_title"
                                                    class="pl-10 py-4 block w-full min-w-[220px] rounded-full border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                                        ...
                                        <div class="col-span-1">
                                            ...
                                            <div class="relative rounded-md shadow-sm">
                                                <select name="job_type" id="job_type"
                                                    class="py-4 block w-full rounded-full border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
                                        ...
                                        <div class="col-span-1">
                                            <label for="application_date"
                                                class="block text-sm font-medium text-gray-700 mb-1">Application Date
                                        ...
                                        <div class="col-span-1">
                                            <label for="reminder_date"
                                                class="block text-sm font-medium text-gray-700 mb-1">Reminder
                                                Date</label>
                                            <div class="relative rounded-md shadow-sm">
                                                <div
                                                    class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                            ...
                            <div>
                                <h3 class="text-lg font-medium text-gray-900 mb-4 mt-2">Additional Information</h3>
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-1">
                                            <textarea name="notes" id="notes" rows="4"
                                                ...
                                                placeholder="Add any notes about the job, interview process, contacts, etc."></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
